...
const showOrdersFromLocalStorage = (localStorageOrders, allOrdersWrapper, totalCount, totalPrice, orderTotalCountNumber, orderTotalPriceNumber) => {
    if (!localStorageOrders.length) {
        ...
        <p style=" margin-top: 2rem;">میتوانید برای مشاهده محصولات  <a href="../../products.html?page=1" style="color: #7B1111; font-weight: bold; font-size: 1.2rem;"> اینجا </a>کلیک کنید</p>
        `
    } else {
        allOrdersWrapper.innerHTML = ''
            ...
            <div class="order-box">
                <div class="order-right">
                    ...
                    <div class="order-count">
                        ...
                        <button class="minus-btn" onclick="minusBtnHandler(event, ${order.price}, '${order.id}')">
        ...
        `)
            ...
            totalPrice = localStorageOrders.reduce(function (accumulator, currentValue) {
                let count = parseInt(currentValue.count);
                let price = parseInt(currentValue.price);
